...
parser.add_argument('--model1', default='Inception_v2', help='pre_trained_model1')
parser.add_argument('--model2', default='VGG', help='pre_trained_model2')
parser.add_argument('--model1_path', default="/model1_path/", help='pre_trained_model1_path')
parser.add_argument('--model2_path', default="/model2_path/", help='pre_trained_model2_path')
    ...
    for epoch in range(args.epoch):
        for step, (x, y) in enumerate(train_loader):
            ...
            if (step+1) % 100 == 0:
                ...
                print('saving model...')
                torch.save(model.state_dict(), args.model_path + 'VGG_EAT.pkl')
                test_op(model)
...
if __name__ == "__main__":
    model_path_list = [args.model1_path,args.model2_path]
    model_name_list = [args.model1,args.model2]
    pretrained_models = model_cifar10(model_path_list,model_name_list)


    real_model_path = args.model_path + 'VGG_EAT.pkl'
